...
function NewsPage() {
  return (
    <Box sx={{ marginTop: 10 }}>
      <Box sx={{ width: '100%', height: '50%', backgroundColor: 'rgb(237,195,71)', padding: '20px 0', textAlign: 'center' }}>
        <Typography variant="h4" sx={{ color: 'white', fontSize: '32px', fontFamily: "Rubik Doodle Shadow" }}>
          Check Out Our Latest Tech Buzz!
        </Typography>
      </Box>
      <Container sx={{ display: 'flex', justifyContent: 'space-between', marginTop: 4 }}>
        <Box sx={{ width: '33%', backgroundColor: 'rgba(53,73,183,0.1)', padding: 2 }}>
          <Typography variant="h3" sx={{ fontSize: '22px', color: '#fff', backgroundColor: '#3557b7', padding: '5px 10px', marginBottom: '10px', textAlign: 'center' }}>
        ...
        <Box sx={{ width: '33%', backgroundColor: 'rgba(53,73,183,0.1)', padding: 2 }}>
          <Typography variant="h3" sx={{ fontSize: '24px', color: '#fff', backgroundColor: '#3557b7', padding: '5px 10px', marginBottom: '10px', textAlign: 'center' }}>
            Video Generation
          </Typography>
